...
func TestReadCgroupProp(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			value:     "12345687",
			expected:  uint64(12345687),
			file:      "/funes.slice/funes.service/memory.max",
			f:         system.ReadCgroupMemLimitBytes,
			cgroupsV2: true,
		},
		{
		...
		},
		{
			...
			f:           system.ReadCgroupMemLimitBytes,
			cgroupsV2:   true,
			expectedErr: "no value found in /sys/fs/cgroup/funes.slice/funes.service/memory.max",
		},
		{
		...
		},
		{
			...
			value:     "3,5,8",
			file:      "/funes.slice/funes.service/cpuset.cpus.effective",
			f:         system.ReadCgroupEffectiveCpusNo,
			expected:  uint64(3),
			cgroupsV2: true,
		},
		...
		},
		{
			...
			file:        "/funes.slice/funes.service/cpuset.cpus.effective",
			f:           system.ReadCgroupEffectiveCpusNo,
			expectedErr: "no value found in /sys/fs/cgroup/funes.slice/funes.service/cpuset.cpus.effective",
			cgroupsV2:   true,
		},
		{
