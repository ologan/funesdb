...
func newListCommand(fs afero.Fs, p *config.Params) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `List available funes tuners and check if they are enabled and 
supported by your system

To enable a tuner it must be set in the funes.yaml configuration file
...
You may use 'rpk funes config set' to enable or disable a tuner.
`,
