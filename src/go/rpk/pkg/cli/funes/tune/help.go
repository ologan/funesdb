...
This is desirable for SSDs - the recommended storage drive for Funes - because
...
current value is below a certain threshold. This allows funes to make as many
