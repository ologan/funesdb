...
const auto oidc_auth_error_data = std::to_array<auth_error_test_data>({
  // Correct
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": "funes", "exp": 1695887942, "iat": 1695887942})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
   oidc::errc::success,
  ...
  // Incorrect issuer
  {1695887942,
   R"({"iss": "wrong", "sub": "subject", "aud": "funes", "exp": 1695887942, "iat": 1695887942})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
  ...
  // Expired
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": "funes", "exp": 1695887941, "iat": 1695887942})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
  ...
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": "funes", "exp": 1695887942, "iat": 1695887943})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
  ...
  // NBF in the future
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": "funes", "exp": 1695887944, "iat": 1695887942, "nbf": 1695887943})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
  ...
  // Correct aud list
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": ["wrong", "funes"], "exp": 1695887942, "iat": 1695887942})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
   oidc::errc::success,
  ...
  // Correct aud list
  {1695887942,
   R"({"iss": "http://docker-rp-1:8080/realms/demorealm", "sub": "subject", "aud": ["funes", "wrong"], "exp": 1695887942, "iat": 1695887942})",
   "http://docker-rp-1:8080/realms/demorealm",
   "funes",
   0s,
   oidc::errc::success,
