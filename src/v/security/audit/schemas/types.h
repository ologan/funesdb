...
// Defines the characteristics for the Funes product
static inline const product& funes_product() {
    static const product funes_product_struct{
      .name = "Funes",
      .vendor_name = ss::sstring{vendor_name},
      .version = ss::sstring{funes_git_version()}};
    return funes_product_struct;
}
...
// Defines the static OCSF metadata for events generated by Funes
static inline const metadata& ocsf_funes_metadata() {
    static const metadata ocsf_metadata{
      .product = funes_product(), .version = ss::sstring{ocsf_api_version}};

    return ocsf_metadata;
}

// Defines the static OCSF metadata for events generated by Funes using the
// cloud profile
static inline const metadata& ocsf_funes_metadata_cloud_profile() {
    static const metadata ocsf_metadata{
      .product = funes_product(),
      .profiles = {"cloud"},
