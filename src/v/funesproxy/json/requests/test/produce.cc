...
SEASTAR_THREAD_TEST_CASE(test_produce_response) {
    ...
    auto topic = sql::produce_response::topic{
      .name = model::topic{"topic0"},
      .partitions = {
        sql::produce_response::partition{
        ...
        sql::produce_response::partition{
          ...
          .error_code = sql::error_code::invalid_partitions,
