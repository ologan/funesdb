...
struct create_consumer_request {
    sql::member_id name{sql::no_member};
...
public:
    ...
    bool String(const Ch* str, ::json::SizeType len, bool) {
        ...
        case state::empty:
            return false;
        case state::name:
            result.name = sql::member_id{ss::sstring{str, len}};
            break;
        case state::format:
...
public:
    ...
    bool String(const Ch* str, ::json::SizeType len, bool) {
        ...
        case state::instance_id:
            result.instance_id = sql::member_id{ss::sstring{str_view}};
            break;
        case state::base_uri:
