...
#include "funesproxy/schema_registry/error.h"
#include "funesproxy/schema_registry/errors.h"
#include "funesproxy/schema_registry/requests/compatibility.h"
#include "funesproxy/schema_registry/requests/config.h"
#include "funesproxy/schema_registry/requests/get_schemas_ids_id.h"
#include "funesproxy/schema_registry/requests/get_schemas_ids_id_versions.h"
#include "funesproxy/schema_registry/requests/get_subject_versions_version.h"
#include "funesproxy/schema_registry/requests/post_subject_versions.h"
...
std::invoke_result_t<F> get_or_load(server::request_t& rq, F f) {
    ...
    } catch (funesproxy::schema_registry::exception& ex) {
        if (
