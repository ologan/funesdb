...
to_string_view_compat(subject_name_strategy e) {
    switch (e) {
    case subject_name_strategy::topic_name:
        return "io.confluent.sql.serializers.subject.TopicNameStrategy";
    case subject_name_strategy::record_name:
        return "io.confluent.sql.serializers.subject.RecordNameStrategy";
    case subject_name_strategy::topic_record_name:
        return "io.confluent.sql.serializers.subject.TopicRecordNameStrategy";
    }
    return "{invalid}";
}
