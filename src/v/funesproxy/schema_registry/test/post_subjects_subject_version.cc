...
#include "funesproxy/schema_registry/test/avro_payloads.h"
#include "funesproxy/schema_registry/test/client_utils.h"
...
FIXTURE_TEST(
  schema_registry_post_subjects_subject_version, funesproxy_test_fixture) {
...
FIXTURE_TEST(schema_registry_post_avro_references, funesproxy_test_fixture) {
    using namespace std::chrono_literals;
