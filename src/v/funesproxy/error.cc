...
namespace funesproxy {

namespace {

struct reply_error_category final : std::error_category {
    const char* name() const noexcept override { return "funesproxy"; }
    std::string message(int ev) const override {
        ...
        case reply_error_code::sql_bad_request:
            return "sql_bad_request";
        case reply_error_code::sql_authentication_error:
            return "sql_authentication_error";
        case reply_error_code::sql_authorization_error:
            return "sql_authorization_error";
        ...
        case reply_error_code::sql_error:
            return "sql_error";
        case reply_error_code::sql_retriable_error:
            return "sql_retriable_error";
...
std::error_condition make_error_condition(std::error_code ec) {
    ...
    if (ec.category() == make_error_code(kec::none).category()) {
        ...
        case kec::reassignment_in_progress:
            return rec::sql_retriable_error;
