...
enum class reply_error_code : uint16_t {
    ...
    sql_bad_request = 40002,
    sql_authentication_error = 40101,
    sql_authorization_error = 40301,
...
template<>
struct is_error_condition_enum<funesproxy::reply_error_code> : true_type {};
