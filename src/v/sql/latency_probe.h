...
public:
    ...
    void setup_metrics() {
        ...
        _metrics.add_group(
          prometheus_sanitize::metrics_name("sql:latency"),
          {
            sm::make_histogram(
              "fetch_latency_us",
        ...
        _public_metrics.add_group(
          prometheus_sanitize::metrics_name("sql"),
          {
            sm::make_histogram(
              ...
              sm::description("Internal latency of sql produce requests"),
              {metrics::make_namespaced_label("request")("produce")},
              [this] { return _produce_latency.public_histogram_logform(); })
              .aggregate({sm::shard_label}),
            sm::make_histogram(
              "request_latency_seconds",
              sm::description("Internal latency of sql consume requests"),
