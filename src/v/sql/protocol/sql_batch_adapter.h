...
constexpr size_t sql_header_size = sizeof(int64_t) + // base offset
 ...
 * requests. This type replaces iobuf in the generated code for sql request
 * types.
 */
