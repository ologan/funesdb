 ...
 * SQL on-wire format. The primary use case for this is the fetch api which
 * returns a set of batches read from a funes log back to a sql client.
 */
class sql_batch_serializer {
public:
    struct result {
        iobuf data;
    ...
    sql_batch_serializer() noexcept
      : _wr(_buf) {}

    sql_batch_serializer(const sql_batch_serializer& o) = delete;
    sql_batch_serializer& operator=(const sql_batch_serializer& o) = delete;
    sql_batch_serializer& operator=(sql_batch_serializer&& o) = delete;

    sql_batch_serializer(sql_batch_serializer&& o) noexcept
