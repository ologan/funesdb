...
///
/// The array bound is not serialized, c.f. array<sql::thing>
...
public:
    ...
    // Consume a model::record_batch as a sql_batch_adaptor
    sql_batch_adapter consume_batch();
    ...
    void print(std::ostream& os) final { os << "{sql::consumer_records}"; }
