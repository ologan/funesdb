...
#include "sql/client/assignment_plans.h"
...
#include "sql/client/topic_cache.h"
...
public:
    ...
    const sql::member_id& member_id() const { return _member_id; }
    const sql::member_id& name() const {
        return _name != sql::no_member ? _name : _member_id;
    }
...
private:
    ...
    sql::member_id _member_id{no_member};
    sql::member_id _name{no_member};
    sql::member_id _leader_id{no_leader};
    std::vector<model::topic> _topics{};
    std::vector<sql::member_id> _members{};
    ...
    ss::noncopyable_function<void(const sql::member_id&)> _on_stopped;
