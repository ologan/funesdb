...
public:
    ...
    ss::future<create_topics_response> create_topic(sql::creatable_topic req);
    ...
    ss::future<member_id>
    create_consumer(const group_id& g_id, member_id name = sql::no_member);
