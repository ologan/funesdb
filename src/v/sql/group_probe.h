...
public:
    ...
    void setup_metrics(
      const sql::group_id& group_id, const model::topic_partition& tp) {
        ...
        _metrics.add_group(
          prometheus_sanitize::metrics_name("sql:group"),
          {sm::make_gauge(
            "offset",
            [this] { return _offset; },
    ...
    void setup_public_metrics(
      const sql::group_id& group_id, const model::topic_partition& tp) {
        ...
        _public_metrics.add_group(
          prometheus_sanitize::metrics_name("sql:consumer:group"),
          {sm::make_gauge(
             "committed_offset",
             [this] { return _offset; },
...
class group_probe {
    ...
    using static_member_map
      = absl::node_hash_map<sql::group_instance_id, sql::member_id>;
...
public:
    ...
    void setup_public_metrics(const sql::group_id& group_id) {
        namespace sm = ss::metrics;
