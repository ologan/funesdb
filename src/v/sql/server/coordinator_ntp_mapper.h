...
/**
 * \brief Mapping from sql coordinator key to ntp.
 *
 * A sql coordinator key is an identifier for a coordinator resource, such as
...
public:
    ...
    std::optional<model::ntp> ntp_for(const sql::group_id& group) const {
