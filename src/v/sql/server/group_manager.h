...
#include "sql/protocol/txn_offset_commit.h"
#include "sql/server/group.h"
#include "sql/server/group_recovery_consumer.h"
#include "sql/server/group_stm.h"
...
/*
 * \brief Manages the SQL group lifecycle.
 *
...
public:
    ...
    described_group describe_group(const model::ntp&, const sql::group_id&);
