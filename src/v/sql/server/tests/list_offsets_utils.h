...
// Wrapper around a SQL transport that encapsulates listing offsets.
//
...
class sql_list_offsets_transport {
public:
    ...
    explicit sql_list_offsets_transport(sql::client::transport&& t)
