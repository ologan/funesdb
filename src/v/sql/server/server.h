...
public:
    server(
      ...
      ss::sharded<sql::group_router>&,
      ss::sharded<sql::usage_manager>&,
      ...
      const std::unique_ptr<funesproxy::schema_registry::api>&) noexcept;
    ...
    std::string_view name() const final { return "sql rpc protocol"; }
    ...
    sql::group_router& group_router() { return _group_router.local(); }
    ...
    sql::fetch_metadata_cache& get_fetch_metadata_cache() {
    ...
    /**
     * \param api_names list of SQL API names
     * \return std::vector<bool> always sized to index the entire SQL API key
...
private:
    ...
    ss::sharded<sql::group_router>& _group_router;
    ss::sharded<sql::usage_manager>& _usage_manager;
    ss::sharded<cluster::shard_table>& _shard_table;
    ss::sharded<cluster::partition_manager>& _partition_manager;
    sql::fetch_session_cache _fetch_session_cache;
    ...
    sql::fetch_metadata_cache _fetch_metadata_cache;
    ...
    const std::unique_ptr<funesproxy::schema_registry::api>& _schema_registry;
};
