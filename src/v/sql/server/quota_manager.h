...
//   quota settings as runtime through the sql api and other mechanisms.
//
...
//   at parity with sql. for example:
//
//      - splitting out rates separately for produce and fetch
//      - accounting per user vs per client (these are separate in sql)
//
