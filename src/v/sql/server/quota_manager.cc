...
quota_manager::quota_manager()
  ...
  , _target_partition_mutation_quota(
      config::shard_local_cfg().sql_admin_topic_api_rate.bind())
  , _target_produce_tp_rate_per_client_group(
      config::shard_local_cfg().sql_client_group_byte_rate_quota.bind())
  , _target_fetch_tp_rate_per_client_group(
      config::shard_local_cfg().sql_client_group_fetch_byte_rate_quota.bind())
  , _gc_freq(config::shard_local_cfg().quota_manager_gc_sec())
  , _max_delay(config::shard_local_cfg().max_sql_throttle_delay_ms.bind()) {
