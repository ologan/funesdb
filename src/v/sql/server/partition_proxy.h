...
/**
 * SQL layer wrapper for partition, this wrapper performs offsets translation
...
public:
    struct impl {
        ...
        virtual sql::leader_epoch leader_epoch() const = 0;
        virtual ss::future<std::optional<model::offset>>
          get_leader_epoch_last_offset(sql::leader_epoch) const = 0;
    ...
    sql::leader_epoch leader_epoch() const { return _impl->leader_epoch(); }

    ss::future<std::optional<model::offset>>
    get_leader_epoch_last_offset(sql::leader_epoch epoch) const {
