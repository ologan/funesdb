 ...
 */
template<SQLApiHandlerAny H>
struct handler_holder {
    static const inline handler_base<SQLApiTwoPhaseHandler<H>> instance{
      handler_info{
        H::api::key,
        H::api::name,
        H::min_supported,
...
std::optional<handler> handler_for_key(sql::api_key key) noexcept {
