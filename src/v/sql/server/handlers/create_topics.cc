...
#include "sql/protocol/timeout.h"
    ...
    std::transform(
      ...
      [](auto& cfg) {
          return creatable_topic_configs{
            ...
            .config_source = sql::describe_configs_source::default_config,
          };
      });
    return configs;
}
...
ss::future<response_ptr> create_topics_handler::handle(
  request_context ctx, [[maybe_unused]] ss::smp_service_group g) {
    sql::create_topics_request request;
