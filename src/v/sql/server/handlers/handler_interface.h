 ...
 *
 * Allows access to all sql request handling implementations though a
...
/**
 * Map a SQL API name to it's API key.
 *
...
/**
 * @return The highest value of SQL API key
 */
