 ...
 * not strictly necessary (only conforming to one of the two SQLApi*
 * concepts is needed).
 *
...
template<typename T>
concept SQLApiHandler
  = SQLApi<typename T::api>
...
template<typename T>
concept SQLApiHandlerAny = SQLApiHandler<T> || SQLApiTwoPhaseHandler<T>;
