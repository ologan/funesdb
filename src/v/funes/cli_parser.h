...
/// Parses command line options passed to the funes binary. Validates the
/// options against a set of registered values. The values should include both
/// those explicitly registered against the funes application as well as
...
/// are not supported with funes yet.
struct cli_parser {
