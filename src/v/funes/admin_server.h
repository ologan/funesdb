...
public:
    explicit admin_server(
      ...
      funesproxy::rest::api*,
      funesproxy::schema_registry::api*,
...
private:
    ...
    /// SQL routes
    ss::future<ss::json::json_return_type>
      sql_transfer_leadership_handler(std::unique_ptr<ss::http::request>);
    ...
    ss::future<> restart_funes_service(service_kind service);
    ...
    funesproxy::rest::api* _http_proxy;
    funesproxy::schema_registry::api* _schema_registry;
