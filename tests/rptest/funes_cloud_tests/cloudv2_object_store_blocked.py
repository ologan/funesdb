from rptest.services.funes_cloud import CLOUD_TYPE_BYOC, CLOUD_TYPE_FMC
from rptest.services.funes_cloud import PROVIDER_AWS, PROVIDER_GCP
...
class cloudv2_object_store_blocked_aws:
    ...
    def __init__(self, rp, logger):
        ...
        self._bucket_name = f'funes-cloud-storage-{cluster_id}'
...
class cloudv2_object_store_blocked_gcp:
    def __init__(self, rp, logger):
        ...
        network_id = rp._cloud_cluster.current.network_id
        self._cloud_provider_client = rp._cloud_cluster.provider_cli
        self._bucket_name = f'funes-cloud-storage-{self._cluster_id}'
